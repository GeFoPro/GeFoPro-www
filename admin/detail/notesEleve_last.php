...
while ($ligne = mysql_fetch_assoc($resultat)) {
	...
	if($ligne['IDTheme']>=10 && $ligne['IDTheme']!=$theme) {
		...
		echo "<tr><td colspan='9' valign='bottom' bgColor='#DEDEDE'></td></tr>";
		echo "\n<tr block$annee$semestre$theme='1' id='hidethis' onclick='toggle(\"block$annee$semestre$theme\");' style='display:".$displayExpand."'><td colspan='2' width='265'><font size='2' face='Verdana'><img src='/iconsFam/bullet_arrow_up.png'> ".$nomTheme."</font></td><td width='40' align='center'><b>Pond</b><br>".$pondTheme."</td><td width='40' align='center'><b>Note</b><br>&nbsp;</td><td colspan='5' align='right' width='660'><img src='/iconsFam/script_add.png' onmouseover=\"Tip('Ajouter une note au thème')\" onmouseout='UnTip()' onclick='limitEvent(event);toggle(\"new$annee$semestre$theme\",\"focus$annee$semestre$theme\");'></td></tr>";
	...
	if($ligne['IDTypeNote']>1 && $ligne['IDTypeNote']<6 ) { //&& empty($ligne['Note'])) {
		...
		if($ligne['NoSemestre']==1) {
			$requeteMoy .= " and (NoSemaine > 30 or NoSemaine <= ".$noSemaineSem2.")";
		} else {
			$requeteMoy .= " and (NoSemaine between ".$noSemaineSem2." and 30)";
		}
	...
	switch($ligne['IDTypeNote']) {
		...
		case 2:
			...
			if(!empty($ligne['Note'])) {
				if(!empty($moyEstimee)) {
					echo " onmouseover=\"Tip('Moyenne des évaluations: ".$moyEstimee."')\" onmouseout='UnTip()'";
				}
			...
			echo "<td tdT$idNote='1' id='hidethis' td colspan='5' width='660'>".$ligne['RemarqueNote']."</td>\n";
			echo "<td tdT$idNote='1' id='hidethis' style='display:none' colspan='5' width='660'><textarea name='RemarqueNote$idNote' COLS=60 ROWS=2 onclick='limitEvent(event)'>".$ligne['RemarqueNote']."</textarea>\n";
			echo "&nbsp;<img src='/iconsFam/tick.png' align='absmiddle' onmouseover=\"Tip('Appliquer les modifications')\" onmouseout='UnTip()' onClick='submitUpdate(".$idNote.",\"".$annee.$semestre.$theme."\")'>";
			echo "&nbsp;<img src='/iconsFam/cross.png' align='absmiddle' onmouseover=\"Tip('Supprimer la note')\" onmouseout='UnTip()' onClick='submitDelete(".$idNote.",\"".$annee.$semestre.$theme."\")'></td>";
			echo "</tr>";
		...
		case 3:
			...
			echo "<td tdA$idNote='1' id='hidethis' td colspan='5' width='660'>".$ligne['RemarqueNote']."</td>\n";
			echo "<td tdA$idNote='1' id='hidethis' style='display:none' colspan='5' width='660'><textarea name='RemarqueNote$idNote' COLS=60 ROWS=2 onclick='limitEvent(event)'>".$ligne['RemarqueNote']."</textarea>\n";
			echo "&nbsp;<img src='/iconsFam/tick.png' align='absmiddle' onmouseover=\"Tip('Appliquer les modifications')\" onmouseout='UnTip()' onClick='submitUpdate(".$idNote.",\"".$annee.$semestre.$theme."\")'>";
			echo "&nbsp;<img src='/iconsFam/cross.png' align='absmiddle' onmouseover=\"Tip('Supprimer la note')\" onmouseout='UnTip()' onClick='submitDelete(".$idNote.",\"".$annee.$semestre.$theme."\")'></td>";
			echo "</tr>";
			if(!empty($ligne['Note'])) {
		...
		case 4:
			...
			echo "<td tdR$idNote='1' id='hidethis' td colspan='5' width='660'>".$ligne['RemarqueNote']."</td>\n";
			echo "<td tdR$idNote='1' id='hidethis' style='display:none' colspan='5' width='660'><textarea name='RemarqueNote$idNote' COLS=60 ROWS=2 onclick='limitEvent(event)'>".$ligne['RemarqueNote']."</textarea>\n";
			echo "&nbsp;<img src='/iconsFam/tick.png' align='absmiddle' onmouseover=\"Tip('Appliquer les modifications')\" onmouseout='UnTip()' onClick='submitUpdate(".$idNote.",\"".$annee.$semestre.$theme."\")'>";
			echo "&nbsp;<img src='/iconsFam/cross.png' align='absmiddle' onmouseover=\"Tip('Supprimer la note')\" onmouseout='UnTip()' onClick='submitDelete(".$idNote.",\"".$annee.$semestre.$theme."\")'></td>";
			echo "</tr>";
			if(!empty($ligne['Note'])) {
		...
		case 5:
			...
			echo "<td tdS$idNote='1' id='hidethis' td colspan='5' width='660'>".$ligne['RemarqueNote']."</td>\n";
			echo "<td tdS$idNote='1' id='hidethis' style='display:none' colspan='5' width='660'><textarea name='RemarqueNote$idNote' COLS=60 ROWS=2 onclick='limitEvent(event)'>".$ligne['RemarqueNote']."</textarea>\n";
			echo "&nbsp;<img src='/iconsFam/tick.png' align='absmiddle' onmouseover=\"Tip('Appliquer les modifications')\" onmouseout='UnTip()' onClick='submitUpdate(".$idNote.",\"".$annee.$semestre.$theme."\")'>";
			echo "&nbsp;<img src='/iconsFam/cross.png' align='absmiddle' onmouseover=\"Tip('Supprimer la note')\" onmouseout='UnTip()' onClick='submitDelete(".$idNote.",\"".$annee.$semestre.$theme."\")'></td>";
			echo "</tr>";
			if(!empty($ligne['Note'])) {
