...
echo "<tr><th width='250'>Th�mes</th><th width='150'>Dates</th><th width='30'>Jours</th><th align='center'>AE/ANE</th>";
if(hasAdminRigth()) {
...
// requete pour liste des cours trouv� pour l'�l�ve
...
if(!empty($cntJours)) {
	...
	echo "<tr><td colspan='9' align='center'>Aucun cours trouv�</td></tr>";
}
