...
<div id="header">
	<div id="logo">
		...
		<td align="right"><a href='<?=$_SESSION['home']?>comp/compList.php'>Gestion du consommable et �quipement</a>
	...
	<div id="menu">
		...
		<ul>
			<?php if(hasAdminRigth()) {
				...
				<?php } else { ?>
				<li class="current_page_item"><a href="<?=$_SESSION['home']?>admin/listes/atelier.php?modeHTML">Retour liste �l�ves</a></li>
				<?php } ?>
			<li class="current_page_item"><a href="<?=$_SESSION['home']?>admin/detail/detailEleve.php?nom=<?=$nom?>&prenom=<?=$prenom?>&idEleve=<?=$IDEleve?>">Fiche �l�ve</a></li>
			...
			<?php  } ?>
			<li class="last"><a href="<?=$_SESSION['home']?>index.php?logout=out">D�connecter</a></li>
			<?php if(hasAdminRigth()) { ?>
