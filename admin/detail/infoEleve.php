...
echo "<center> <font color='#088A08'>Veuillez signaler au responsable de section les �ventuelles erreurs ou changements � effectuer</font></center><br>";
...
echo "<div id='legend'>Donn�es personnelles</div>";
...
echo "<tr><td>T�l�phone</td><td>Portable</td><td></td></tr>";
