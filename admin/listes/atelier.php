...
if(!$modeHTML) {
	...
	echo "<div class='post'><div id='corners'><div id='legend'>".Profession." (".$app_section.") $annee - $anneePlus</div><table id='hor-minimalist-b' width='100%'><tr><th colspan='2'><a href='atelier.php'><img src='/iconsFam/page_excel.png' onmouseover=\"Tip('".libelleTrad('listexcel')."')\" onmouseout='UnTip()'></a>";
