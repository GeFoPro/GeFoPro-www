	...
	//echo $requete."<br>";
			...
			if((!empty($classe)&&$classe!=0)||$ligne['IDEntreprise']==1) {
				if(!$modeHTML) {
					...
					echo "<tr block$pos='$idGDN' id='hidethis' onclick='updateEleve($idGDN,\"$nom\",\"$prenom\");'";
...
<tr><td width='5'></td><td>Formation 3 + 1</td><td><img src='/iconsFam/award_star_gold_1.png'></td><td width='100'></td><td>Délégué de classe</td><td><img src='/iconsFam/rosette.png'></td><td width='100'></td><td>Horaire bloqué</td><td><img src='/iconsFam/clock_error.png'></td></tr>
...
<tr><td width='5'></td><td>Inscrit(e) 3 + 1, prép. MPT</td><td><img src='/iconsFam/award_star_silver_3.png'></td><td width='100'></td><td>Cours prép. MPT</td><td><img src='/iconsFam/medal_silver_3.png'></td></tr>
</table></div>
</div> <!-- post -->
</form>
<?php } // has admin right?>
