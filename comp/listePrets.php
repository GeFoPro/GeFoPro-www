...
echo "<div id='legend'>Liste des pr�ts";
if(!empty($IDStockage)) {
	echo " de l'appareil";
}
echo "</div>";
echo "<table id='hor-minimalist-b' width='100%' border='0'>\n";
echo "<tr><th width='300'>Appareil</th><th width='100' align='center'>No Inventaire</th><th width='100' align='center'>Emplacement</th><th  width='200'>Utilis� par</th><th>Depuis</th><th width='10'></th></tr>";
mysqli_select_db($connexionDB,DBComp);
$filtreSQLUser = "";
if(empty($uid)) {
