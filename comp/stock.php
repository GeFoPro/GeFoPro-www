...
<table border='0' id="hor-minimalist-b" width='100%'><tr><th>Emplacement</th><th align='center'>Tirroir/étagère -<br>Boîte/rangement</th><th align='center'>Emplacement<br>RFID</th><th align='center'>Quantité<br>actuelle</th><th align='center'>Quantité<br>minimale</th><th align='center'>Quantité<br>commande</th><th></th></tr>
...
where IDComposant=$IDComp";
  ...
  if(hasStockRight()) {
  ?>
  <tr newStock='1'><td colspan='7' bgColor='#5C5C5C'></td></tr>
  <tr newStock='1'><td></td><td></td><td></td><td></td><td></td><td></td><td align='right'><img src='/iconsFam/add.png' onmouseover="Tip('Ajouter un emplacement')" onmouseout='UnTip()' onclick='toggle("newStock");' align='absmiddle'></td></tr>
