...
<!-- h2>Liste des articles � commander</h2 -->
...
<div id='corners'>
<div id='legend'>Liste des articles � commander</div>
<?php
...
<tr><td>Command� par: <input type='text' name='compar' onChange='submitRecherche(this.form)' value='<?=(!empty($likeComPar)?$likeComPar:"")?>'></input></td>
...
if(!hasAdminRigth()) {
	// afficher uniquement ses propres composants command�s
...
// cr�er ent�te
			...
			echo "<th align='left'>Libell�</th>";
			echo "<th align='right'>Quantit�</th>";
			echo "<th align='right'>Prix unitaire</th>";
			echo "<th align='right' width='60'>Total</th>";
			echo "<th align='left'>Command� par</th><th></th></tr>";
if(!empty($resultat)) {
	$noArticle = "";
	while ($ligne = mysqli_fetch_assoc($resultat) ) {
		...
		// recherche si article semble exister dans la gestion du mat�riel
		/* liste composants */
		/*
...
if(empty($recu) && (!empty($critere) || !empty($IDPageCommande))) {
	...
	if(empty($IDPageCommande)) {
		echo "<img src='/iconsFam/add.png' onmouseover=\"Tip('Ajouter un article � commander')\" onmouseout='UnTip()' onclick='toggle(\"newArticle\");document.getElementById(\"myForm\").NumArticle.focus();' align='right'>";
	}
	echo "</td></tr>";
}
...
<!-- h2>Commande</h2 -->
<table border=0>
<tr><td>Cr�ateur :</td><td><input type='text' size='4' name='Abbr' value=''>
</td></tr>
...
<option>Consommables</option>
<option>Entit� existante</option>
<option>Investissement</option>
<option>Maintenance</option>
<option>Nouvelle entit�</option>
<option>Remplacement</option>
<option>R�paration</option>
<option>Revente �l�ves</option>
<option>Travaux pour tiers</option>
</select></td></tr>
<tr><td>Avec TVA :</td><td><input type="checkbox" name="Tva"></tr>
<tr><td>Intitul� :</td><td><input type="texte" name="Remarque" value="" size="35"</td></tr>
<tr><td></td><td>
<input type="submit" name="Submit" value="Commander"> <input type="checkbox" name="Definitif">Commande d�finitive
