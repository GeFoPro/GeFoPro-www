...
echo "<div class='post'>";
//if(isset($critere) && !empty($critere)) {
//	echo "<br><h2>R�sultat trouv� pour '$critere'</h2><br>";
//} else {
...
<?php
if(isset($critere) && !empty($critere)) {
	echo "<div id='legend'>R�sultat trouv� pour '$critere'</div>";
} else {
...
<th align="left" width="250"><a href="compList.php?tri=Valeur&sens=<?=$newSens?>">Valeur<?=$affSensVal?></a> / Caract�risitiques</th>
<?php } else { ?>
<th align="left" width="430"><a href="compList.php?tri=Valeur&sens=<?=$newSens?>">Valeur<?=$affSensVal?></a> / Caract�risitiques</th>
<?php } ?>
<!-- th align="left" width="20"><a href="compList.php?tri=Caracteristiques&sens=<?=$newSens?>">Caract�ristiques<?=$affSensCar?></a></th -->
...
<td colspan="7">
<?php } ?>
<a href="compList.php?limit=<?=$limit-50?>"><< Pr�c�dents</a></td></tr>
<?php } ?>
<?php
echo $pageOut;
?>
