...
?>
  ...
  <a href="#" onClick="toggleForm('IDSchNew','SchNew')"><img src="/iconsFam/table_edit.png" align="absmiddle" onmouseover="Tip('Editer la liste des sch�mas')" onmouseout="UnTip()"></a></div>
  <div id="SchNew"><input type="texte" name="SchemaNew" value="" size="25"><a href="#" onClick="toggleForm('IDSchNew','SchNew')"><img src="/iconsFam/table.png" align='absmiddle' onmouseover="Tip('Retour � la liste')" onmouseout="UnTip()"></a></div>
...
?>
  ...
  <div id="RefNew"><input type="texte" name="ReferenceNew" value="" size="25"><a href="#" onClick="toggleForm('IDRefNew','RefNew')"><img src="/iconsFam/table.png" align='absmiddle' onmouseover="Tip('Retour � la liste')" onmouseout="UnTip()"></a></div>
